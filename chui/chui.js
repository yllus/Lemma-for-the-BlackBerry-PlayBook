...
$.UIScroll.prototype = {
    ...
    _resetPos: function (time) {
    	// Lemma: Disable scrolling automatically to the top of the page.
    	return;
        ...
        if (that.y >= 0 || that.maxScrollY > 0) resetY = 0;
       	...
       	if (that.y < that.maxScrollY) resetY = that.maxScrollY;
...
$.extend($, {
    ...
    UIShowPopUp : function( selector ) {
        ...
        var screenCover = $("view > screencover");
...
$.extend(HTMLElement.prototype, {
    UIActionSheet : function(opts) {
        ...
        var createActionSheet = function() {
            ...
            // Lemma: Add the title to the top of the action sheet.
            var as_title = opts.title;
            as_title = as_title.replace('color: #000;', 'color: #2489CE;');
            actionSheetStr += "<span class=\"actiontweet\">" + as_title + "</span>";
            ...
            if (!!opts.uiButtons) {
                for (var i = 0, len = opts.uiButtons.length; i < len; i++) {
                    ...
                    uiButtons += ' ui-implements="' + uiButtonImplements + '" class="stretch" ontouchstart="' + uiButtonCallback + '(\'#' + actionSheetID + '\')"><label>';
                    uiButtons += uiButtonTitle;
                    uiButtons +=    "</label></uibutton>"   ;           
                }
            }
            actionSheetStr += uiButtons + "<uibutton ui-kind='action' ui-implements='cancel' class='stretch' ontouchstart='$.UIHideActionSheet(\"#" + actionSheetID + "\")'><label>Cancel</label></uibutton></scrollpanel></actionsheet>";
